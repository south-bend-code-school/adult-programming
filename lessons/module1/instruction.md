...
## Kick Off (The big picture) (10 min)

[Presentation](https://docs.google.com/presentation/d/1uOO40fcnidLgHW19PhMslqgpXjXq1SvuipPHNI0JKLE/edit?usp=sharing)
- Welcome to "Intro to Careers in Coding"
- Take time to introduce yourself as the instructor, share some personal / professional details.  Get to know the class.
- Describe what coding is
- Explain why coding is important
- Outline the high demand for careers in coding


## Run through the Agenda for today (1 min)
The best way to learn about coding is to get hands on and actually code.
  - Code with HTML
  - Code with CSS
  - Discuss Front-End Developer Careers

## Address feeling overwhelmed with the students (3 min)
Students will feel overwhelmed at times.  There is going to be a crazy amount of terms and tech thrown at them and it all can be VERY confusing.  Spend a few minutes to let them know that this is okay and that you are going to help get through this with them together.

- Encourage students to ask questions whenever they want. If they have a question, someone else does too. 
- For example, you might ask the students to identify their level of experience so they know they are not alone.
- Students will have to transition between watching your screen and coding. Juggling multiple windows can be overwhelming.  Give the students time to setup their display.
- Go slow.  You may accidentally speed ahead since I am not switching windows and are more familiar with the material.  Give the students time to process.
...
- Getting started can feel hard and confusing but we are hear to help. 
